...
const NavBar = () => {
    ...
    return (
        <div className={`${sticky ? "w-full duration-500 transition-all bg-opacity-40 bg-gray-100 backdrop-filter backdrop-saturate-200 backdrop-blur-3xl" : " w-full"}  bg-opacity-5 bg-[#f6f4f3] fixed py-4 px-[8%]`}>
            <div >
                <div className="flex  py-3 justify-between items-center">
                    ...
                    <div>
                        <ul className="flex uppercase mr-4">
                            <Link><li className="mr-8 text-[#496558] hover:text-white duration-300 transition-all">EXPLORE</li></Link>
