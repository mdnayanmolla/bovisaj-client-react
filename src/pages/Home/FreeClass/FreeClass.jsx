...
const FreeClass = () => {
    ...
    return (
        <div className="relative overflow-hidden">
            <div className='absolute -top-10 -left-8 h-40 w-40 -z-10'>
            ...
            <div className='text-center py-24'>
                <button className="bg-[#496558] font-bold px-16 text-[#E6DCD4] py-4 rounded-full text-[14px] uppercase hover:bg-white hover:text-[#496558] hover:border hover:border-[#496558]
            ...
            <motion.div className=' -z-10 h-40 w-40 absolute -bottom-[500px] right-0' style={{ y: yBg2 }}>
