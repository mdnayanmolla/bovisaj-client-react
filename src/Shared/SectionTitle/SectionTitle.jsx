    ...
    return (
        <div className="pt-24">
            <div className="w-3/4 mx-auto text-center">
                <h2 className="text-6xl text-[#496558] font-semibold tracking-wider">{titleHeadingTop}</h2>
                <h2 className="text-6xl text-[#496558] font-semibold tracking-wider">{titleHeadingBottom}</h2>
